    ...
    <div class="container mt-3">
        <div class="row mt-3">
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Concert Decoration 1.jpg" class="card-img-top" alt="Concert Decoration 1">
                        <div class="card-body text-center">
                            <h5 class="card-title">Concert Decoration 1</h5>
                            <p class="card-text">₹ 48,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Concert Decoration 1">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Concert Decoration 2.jpg" class="card-img-top" alt="Concert Decoration 2">
                        <div class="card-body text-center">
                            <h5 class="card-title">Concert Decoration 2</h5>
                            <p class="card-text">₹ 49,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Concert Decoration 2">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Concert Decoration 3.jpg" class="card-img-top" alt="Concert Decoration 3">
                        <div class="card-body text-center">
                            <h5 class="card-title">Concert Decoration 3</h5>
                            <p class="card-text">₹ 50,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Concert Decoration 3">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Concert Decoration 4.jpg" class="card-img-top" alt="Concert Decoration 4">
                        <div class="card-body text-center">
                            <h5 class="card-title">Concert Decoration 4</h5>
                            <p class="card-text">₹ 47,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Concert Decoration 4">
        ...
        <div class="row mt-5">
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Concert Decoration 5.jpg" class="card-img-top" alt="Concert Decoration 5">
                        <div class="card-body text-center">
                            <h5 class="card-title">Concert Decoration 5</h5>
                            <p class="card-text">₹ 58,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Concert Decoration 5">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Concert Decoration 6.jpg" class="card-img-top" alt="Concert Decoration 6">
                        <div class="card-body text-center">
                            <h5 class="card-title">Concert Decoration 6</h5>
                            <p class="card-text">₹ 49,799.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Concert Decoration 6">
                            <input type="hidden" name="Price" value="49799">
                        </div>
                    </div>
                </form>
            </div>
