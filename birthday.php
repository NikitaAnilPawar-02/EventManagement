      ...
      <div class="container mt-3">
            <div class="row mt-3">
                  <div class="col-lg-3">
                        <form action="manage_cart.php" method="POST">
                              <div class="card">
                                    <img src="Cart/Candy Theme Birthday Decoration.jpg" class="card-img-top" alt="Candy Theme Birthday Decoration">
                                    <div class="card-body text-center">
                                          <h5 class="card-title">Candy Theme Birthday Decoration</h5>
                                          <p class="card-text">₹ 8,999.00</p>
                                          <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                                          <input type="hidden" name="Item_Name" value="Candy Theme Birthday Decoration">
                  ...
                  <div class="col-lg-3">
                        <form action="manage_cart.php" method="POST">
                              <div class="card">
                                    <img src="Cart/Golden Theme Birthday Decoration.jpg" class="card-img-top" alt="Golden Theme Birthday Decoration">
                                    <div class="card-body text-center">
                                          <h5 class="card-title">Golden Theme Birthday Decoration</h5>
                                          <p class="card-text">₹ 8,999.00</p>
                                          <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                                          <input type="hidden" name="Item_Name" value="Golden theme birthday decoration">
                                          <input type="hidden" name="Price" value="8999">
                                    </div>
                              </div>
                        </form>
                  ...
                  <div class="col-lg-3">
                        <form action="manage_cart.php" method="POST">
                              <div class="card">
                                    <img src="Cart/Rose Gold Pastel Birthday Decoration.jpg" class="card-img-top" alt="Rose Gold Pastel Birthday Decoration">
                                    <div class="card-body text-center">
                                          <h5 class="card-title">Rose Gold Pastel Birthday Decoration</h5>
                                          <p class="card-text">₹ 9,999.00</p>
                                          <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                                          <input type="hidden" name="Item_Name" value="Rose Gold Pastel Birthday Decoration">
                  ...
                  <div class="col-lg-3">
                        <form action="manage_cart.php" method="POST">
                              <div class="card">
                                    <img src="Cart/Yellow Theme Birthday Decoration.jpg" class="card-img-top" alt="Yellow Theme Birthday Decoration">
                                    <div class="card-body text-center">
                                          <h5 class="card-title">Yellow Theme Birthday Decoration</h5>
                                          <p class="card-text">₹ 7,999.00</p>
                                          <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                                          <input type="hidden" name="Item_Name" value="Yellow Theme Birthday Decoration">
            ...
            <div class="row mt-5">
                  <div class="col-lg-3">
                        <form action="manage_cart.php" method="POST">
                              <div class="card">
                                    <img src="Cart/Car Theme Birthday Decoration.jpg" class="card-img-top" alt="Car Theme Birthday Decoration">
                                    <div class="card-body text-center">
                                          <h5 class="card-title">Car Theme Birthday Decoration</h5>
                                          <p class="card-text">₹ 5,999.00</p>
                                          <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                                          <input type="hidden" name="Item_Name" value="Car Theme Birthday Decoration">
                  ...
                  <div class="col-lg-3">
                        <form action="manage_cart.php" method="POST">
                              <div class="card">
                                    <img src="Cart/Skyblue White Birthday Decoration.jpg" class="card-img-top" alt="Skyblue White Birthday Decoration">
                                    <div class="card-body text-center">
                                          <h5 class="card-title">Skyblue White Birthday Decoration</h5>
                                          <p class="card-text">₹ 8,999.00</p>
                                          <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                                          <input type="hidden" name="Item_Name" value="Skyblue White Birthday Decoration">
                                          <input type="hidden" name="Price" value="8999">
                                    </div>
                              </div>
                        </form>
                  ...
                  <div class="col-lg-3">
                        <form action="manage_cart.php" method="POST">
                              <div class="card">
                                    <img src="Cart/White Net with Lights Birthday Decoration.jpg" class="card-img-top" alt="White Net with Lights Birthday Decoration">
                                    <div class="card-body text-center">
                                          <h5 class="card-title">White Net with Lights Birthday Decoration</h5>
                                          <p class="card-text">₹ 10,999.00</p>
                                          <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                                          <input type="hidden" name="Item_Name" value="White Net with Lights Birthday Decoration">
                  ...
                  <div class="col-lg-3">
                        <form action="manage_cart.php" method="POST">
                              <div class="card">
                                    <img src="Cart/Cherish Rose Gold Birthday Decoration.jpg" class="card-img-top" alt="Cherish Rose Gold Birthday Decoration">
                                    <div class="card-body text-center">
                                          <h5 class="card-title">Cherish Rose Gold Birthday Decoration</h5>
                                          <p class="card-text">₹ 9,999.00</p>
                                          <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                                          <input type="hidden" name="Item_Name" value="Cherish Rose Gold Birthday Decoration">
                                          <input type="hidden" name="Price" value="9999">
                                    </div>
                              </div>
                        </form>
