    ...
    <div class="container mt-3">
        <div class="row mt-3">
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Pastel Theme Baby Shower Decoration.jpg" class="card-img-top" alt="Pastel Theme Baby Shower Decoration">
                        <div class="card-body text-center">
                            <h5 class="card-title">Pastel Theme Baby Shower Decoration</h5>
                            <p class="card-text">₹ 4,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Pastel Theme Baby Shower Decoration">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Pink Ring Baby Shower Decoration.jpg" class="card-img-top" alt="Pink Ring Baby Shower Decoration">
                        <div class="card-body text-center">
                            <h5 class="card-title">Pink Ring Baby Shower Decoration</h5>
                            <p class="card-text">₹ 4,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Pink Ring Baby Shower Decoration">
                            <input type="hidden" name="Price" value="4999">
                        </div>
                    </div>
                </form>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Jungle Theme Baby Shower Decoration.jpg" class="card-img-top" alt="Jungle Theme Baby Shower Decoration">
                        <div class="card-body text-center">
                            <h5 class="card-title">Jungle Theme Baby Shower Decoration</h5>
                            <p class="card-text">₹ 5,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Jungle Theme Baby Shower Decoration">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Rosegold Ring Baby Shower Decoration.jpg" class="card-img-top" alt="Rosegold Ring Baby Shower Decoration">
                        <div class="card-body text-center">
                            <h5 class="card-title">Rosegold Ring Baby Shower Decoration</h5>
                            <p class="card-text">₹ 4,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Rosegold Ring Baby Shower Decoration">
                            <input type="hidden" name="Price" value="4999">
                        </div>
                    </div>
                </form>
        ...
        <div class="row mt-5">
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Golden Baby Shower Decoration.jpg" class="card-img-top" alt="Golden Baby Shower Decoration">
                        <div class="card-body text-center">
                            <h5 class="card-title">Golden Baby Shower Decoration</h5>
                            <p class="card-text">₹ 5,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Golden Baby Shower Decoration">
                            <input type="hidden" name="Price" value="5999">
                        </div>
                    </div>
                </form>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Elegant Baby Shower Decoration.jpg" class="card-img-top" alt="Elegant Baby Shower Decoration">
                        <div class="card-body text-center">
                            <h5 class="card-title">Elegant Baby Shower Decoration</h5>
                            <p class="card-text">₹ 4,799.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Elegant Baby Shower Decoration">
