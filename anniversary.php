    ...
    <div class="container mt-3">
        <div class="row mt-3">
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Marriage Anniversary Decoration 1.jpg" class="card-img-top" alt="Marriage Anniversary Decoration 1">
                        <div class="card-body text-center">
                            <h5 class="card-title">Marriage Anniversary Decoration 1</h5>
                            <p class="card-text">₹ 4,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Marriage Anniversary Decoration 1">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Marriage Anniversary Decoration 2.jpg" class="card-img-top" alt="Marriage Anniversary Decoration 2">
                        <div class="card-body text-center">
                            <h5 class="card-title">Marriage Anniversary Decoration 2</h5>
                            <p class="card-text">₹ 4,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Marriage Anniversary Decoration 2">
                            <input type="hidden" name="Price" value="4999">
                        </div>
                    </div>
                </form>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Marriage Anniversary Decoration 3.jpg" class="card-img-top" alt="Marriage Anniversary Decoration 3">
                        <div class="card-body text-center">
                            <h5 class="card-title">Marriage Anniversary Decoration 3</h5>
                            <p class="card-text">₹ 5,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Marriage Anniversary Decoration 3">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Marriage Anniversary Decoration 4.jpg" class="card-img-top" alt="Marriage Anniversary Decoration 4">
                        <div class="card-body text-center">
                            <h5 class="card-title">Marriage Anniversary Decoration 4</h5>
                            <p class="card-text">₹ 4,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Marriage Anniversary Decoration 4">
                            <input type="hidden" name="Price" value="4999">
                        </div>
                    </div>
                </form>
        ...
        <div class="row mt-5">
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Marriage Anniversary Decoration 5.jpg" class="card-img-top" alt="Marriage Anniversary Decoration 5">
                        <div class="card-body text-center">
                            <h5 class="card-title">Marriage Anniversary Decoration 5</h5>
                            <p class="card-text">₹ 5,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Marriage Anniversary Decoration 5">
                            <input type="hidden" name="Price" value="5999">
                        </div>
                    </div>
                </form>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Marriage Anniversary Decoration 6.jpg" class="card-img-top" alt="Marriage Anniversary Decoration 6">
                        <div class="card-body text-center">
                            <h5 class="card-title">Marriage Anniversary Decoration 6</h5>
                            <p class="card-text">₹ 4,799.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Marriage Anniversary Decoration 6">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Marriage Anniversary Decoration 7.jpg" class="card-img-top" alt="Marriage Anniversary Decoration 7">
                        <div class="card-body text-center">
                            <h5 class="card-title">Marriage Anniversary Decoration 7</h5>
                            <p class="card-text">₹ 4,899.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Marriage Anniversary Decoration 7">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Marriage Anniversary Decoration 8.jpg" class="card-img-top" alt="Marriage Anniversary Decoration 8">
                        <div class="card-body text-center">
                            <h5 class="card-title">Marriage Anniversary Decoration 8</h5>
                            <p class="card-text">₹ 4,699.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Marriage Anniversary Decoration 8">
