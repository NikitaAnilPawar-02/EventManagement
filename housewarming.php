    ...
    <div class="container mt-3">
        <div class="row mt-3">
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Housewarming Decorations 1.jpg" class="card-img-top" alt="Housewarming Decorations 1">
                        <div class="card-body text-center">
                            <h5 class="card-title">Housewarming Decorations 1</h5>
                            <p class="card-text">₹ 14,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Housewarming Decorations 1">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Housewarming Decorations 2.jpg" class="card-img-top" alt="Housewarming Decorations 2">
                        <div class="card-body text-center">
                            <h5 class="card-title">Housewarming Decorations 2</h5>
                            <p class="card-text">₹ 14,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Housewarming Decorations 2">
                            <input type="hidden" name="Price" value="14999">
                        </div>
                    </div>
                </form>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Housewarming Decorations 3.jpg" class="card-img-top" alt="Housewarming  3">
                        <div class="card-body text-center">
                            <h5 class="card-title">Housewarming Decorations 3</h5>
                            <p class="card-text">₹ 15,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Housewarming Decorations 3">
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Housewarming Decorations 4.jpg" class="card-img-top" alt="Housewarming Decorations 4">
                        <div class="card-body text-center">
                            <h5 class="card-title">Housewarming Decorations 4</h5>
                            <p class="card-text">₹ 14,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Housewarming Decorations 4">
                            <input type="hidden" name="Price" value="14999">
                        </div>
                    </div>
                </form>
        ...
        <div class="row mt-5">
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Housewarming Decorations 5.jpg" class="card-img-top" alt="Housewarming Decorations 5">
                        <div class="card-body text-center">
                            <h5 class="card-title">Housewarming Decorations 5</h5>
                            <p class="card-text">₹ 15,999.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Housewarming Decorations 5">
                            <input type="hidden" name="Price" value="15999">
                        </div>
                    </div>
                </form>
            ...
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Housewarming Decorations 6.jpg" class="card-img-top" alt="Housewarming Decorations 6">
                        <div class="card-body text-center">
                            <h5 class="card-title">Housewarming Decorations 6</h5>
                            <p class="card-text">₹ 14,799.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Housewarming Decorations 6">
                            <input type="hidden" name="Price" value="14799">
                        </div>
                    </div>
                </form>
            </div>
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Housewarming Decorations 7.jpg" class="card-img-top" alt="Housewarming Decorations 7">
                        <div class="card-body text-center">
                            <h5 class="card-title">Housewarming Decorations 7</h5>
                            <p class="card-text">₹ 14,899.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Housewarming Decorations 7">
                            <input type="hidden" name="Price" value="14899">
                        </div>
                    </div>
                </form>
            </div>
            <div class="col-lg-3">
                <form action="manage_cart.php" method="POST">
                    <div class="card">
                        <img src="Cart/Housewarming Decorations 8.jpg" class="card-img-top" alt="Housewarming Decorations 8">
                        <div class="card-body text-center">
                            <h5 class="card-title">Housewarming Decorations 8</h5>
                            <p class="card-text">₹ 14,699.00</p>
                            <button type="submit" name="Add_to_Cart" class="btn btn-success">Add to Cart </button>
                            <input type="hidden" name="Item_Name" value="Housewarming Decorations 8">
