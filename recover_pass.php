            ...
            <div class="position-absolute top-50 start-50 translate-middle form shadow-lg py-5 px-4">
                  <div class="container">
                        <div class="text-center">
                              <img src="Photos/l4.png" alt="Avatar" height="80" weight="80">
                              <h3><b>Recover Account</b></h3>
                        ...
                        <div class="input-group mb-3">
                              ...
                              <input type="password" class="form-control" placeholder="New Password" name="Newpassword" size="25" required>
                        </div>
                        <div class="input-group mb-3">
                              <span class="input-group-text"><i class="fa-solid fa-key" style="color: purple;"></i></span>
                        ...
                        <div class="text-end">
                              <small>Already have an account? <a href="login.php">Login now</a></small><br>
                        </div>
                  </div>
            </div>
